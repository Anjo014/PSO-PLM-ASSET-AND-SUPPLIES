...
<html lang="en">
    ...
    <body>
        ...
        <div>
            <a href="<?php echo e(url('suppliers-view')); ?>" class="btn btn-danger">Cancel</a>
        </div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(url('/storesupplier')); ?>" class="form-body" method="POST" autocomplete="off">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="contact_number" name="contact_number" class="form-control <?php $__errorArgs = ['contact_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/assets/addsupplier.blade.php ENDPATH**/ ?>