...
<html lang="en">
    ...
    <body>
        ...
        <div>
            <h4>
                <a href="<?php echo e(url('/supplies-issued-create')); ?>" class="btn btn-primary"><strong>ADD ISSUED</strong></a>
            </h4>
        <div>
        ...
        <div class="container">
            <div class="table-container">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $suppliesissued; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issueddata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(url('issued-iedit/'.$issueddata->stock_no)); ?>" class="btn-edit" style="text-decoration: none;">Edit</a>
                            </td>
                        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/supplies/issued.blade.php ENDPATH**/ ?>