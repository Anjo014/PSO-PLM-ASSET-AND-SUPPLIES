...
<body class="plmbg">
        ...
        <div class="text">
        <h1><strong>PLM Supplies</strong> <br></h1>
        <h3>Sign In </h3> </div>
    <div class=" row"></div>
    <div class="col-lg-3">
        <div class="card-body">
            <div class="field-group" style="top: 280px; position: fixed; left: 250px;">
            <form action="<?php echo e(route('login', 'supply')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="portal" value="supply">
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/index.blade.php ENDPATH**/ ?>