                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(url('/updatesupplies/'.$supply->pr_no)); ?>" class="form-body" method="POST" autocomplete="off">
                                <?php echo csrf_field(); ?> 
                                <?php echo method_field('PUT'); ?> 
                                <div class="input-group">
                                    <label for="stock_no"><strong>Stock No:</strong></label>
                                    <input type="text" name="stock_no" value="<?php echo e($supply->stock_no); ?>" class="form-control <?php $__errorArgs = ['description'];
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="description" value="<?php echo e($supply->description); ?>" class="form-control <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="unit" value="<?php echo e($supply->unit); ?>" class="form-control <?php $__errorArgs = ['unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/supplies/editsupply.blade.php ENDPATH**/ ?>