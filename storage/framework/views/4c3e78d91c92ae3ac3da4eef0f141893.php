...
<html lang="en">
    ...
    <body>
        ...
        <div class="side-bar" style="padding: 10px;">
            ...
            <h2 style="color: white; text-align: center; font-size: 20px;">Supplies Issued</h2>
        </div>
        ...
        <div class="container">
            <div class="table-container">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $issued; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issueddata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($issueddata->stock_no); ?></td>
                            <td><?php echo e($issueddata->description); ?></td>
                            <td><?php echo e($issueddata->date_issuance); ?></td>
                            <td><?php echo e($issueddata->requesting_office); ?></td>
                            <td><?php echo e($issueddata->report_no); ?></td>
                            <td><?php echo e($issueddata->ris_no); ?></td>
                            <td><?php echo e($issueddata->issued); ?></td>
                            <td><?php echo e($issueddata->updated_at); ?></td>
                            <td>
                                <a href="<?php echo e(url('editissued/'.$issueddata->stock_no)); ?>" class="btn-edit" style="text-decoration: none;">Edit</a>
                            </td>
                        </tr>
        ...
        <div class="dropdown" style="position: absolute; border:none;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="top: 10px; left: 10px; background-color: transparent; border: none;">
                <a class="dropdown-item" href="/supplies-view" style="color: white; background-color: transparent;">Main</a>
                <a class="dropdown-item" href="/issued-supplies-view" style="color: white; background-color: transparent;">Issued</a>
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/supplies/issuedsupply.blade.php ENDPATH**/ ?>