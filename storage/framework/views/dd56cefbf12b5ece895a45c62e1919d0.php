...
<body >
    ...
    <div>
    <pre style="font-family: Arial; font-size: 15px;">Supplier: <?php echo e(session('form_data.supplier')); ?>    IAR No: <?php echo e(session('form_data.iar')); ?> <br>
PO No: <?php echo e(session('form_data.po')); ?>   BUR No: <?php echo e(session('form_data.bur')); ?>     PR No: <?php echo e(session('form_data.pr')); ?> <br> 
Date of PO:  <?php echo e(session('form_data.date_po')); ?>  Invoice No: <?php echo e(session('form_data.invoice')); ?> <br>
Req Office: <?php echo e(session('form_data.roffice')); ?>                           Date of Invoice: <?php echo e(session('form_data.date_invoice')); ?> 
    </pre>
    </div>
    ...
    <table style="border: 1px solid black; text-align: center;">
        ...
        <?php if(is_array(session('form_data.item_no'))): ?>
            <?php $__currentLoopData = session('form_data.item_no'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item_no): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td colspan="5"></td>
                    <td><?php echo e(session('form_data.unitcost')[$index]); ?></td>
                    <td><?php echo e(session('form_data.qty')[$index] * session('form_data.unitcost')[$index]); ?></td>
                </tr>
        ...
        <?php else: ?>
            <tr>
                ...
                <td colspan="5"></td>
                <td><?php echo e(session('form_data.unitcost')); ?></td>
                <td><?php echo e(session('form_data.qty') * session('form_data.unitcost')); ?></td>
            </tr>
        <?php endif; ?>
            <tr>
    ...
    <div>
        <pre>Date Inspected:  <?php echo e(session('form_data.date_inspected')); ?>                         Date Received:  <?php echo e(session('form_data.date_received')); ?>  </pre>
    </div>
    ...
    <div>
        <pre> <?php echo e(session('form_data.officer')); ?>            <?php echo e(session('form_data.chief')); ?> </pre>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo e(route('generatePDF2')); ?>">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/supplies/iarform.blade.php ENDPATH**/ ?>