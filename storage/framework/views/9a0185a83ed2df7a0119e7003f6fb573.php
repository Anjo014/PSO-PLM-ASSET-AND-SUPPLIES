...
<html lang="en">
    ...
    <body>
        ...
        <div>
            <h4>
                <a href="<?php echo e(url('/makepurchaseorder')); ?>" class="btn btn-primary"><strong>Make Purchase Order</strong></a>
            </h4>
        <div>
            ...
            <div class="table-container">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <?php $__currentLoopData = $asset; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assetdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($assetdata->item_no); ?></td>
                            <td><?php echo e($assetdata->description); ?></td>
                            <td><?php echo e($assetdata->po_no); ?></td>
                            <td><?php echo e($assetdata->supplier); ?></td>
                            <td><?php echo e($assetdata->address); ?></td>
                            <td><?php echo e($assetdata->tel_no); ?></td>
                            <td><?php echo e($assetdata->tin_no); ?></td>
                            <td><?php echo e($assetdata->date); ?></td>
                            <td><?php echo e($assetdata->mode_of_proc); ?></td>
                            <td><?php echo e($assetdata->pr_no); ?></td>
                            <td><?php echo e($assetdata->place_dev); ?></td>
                            <td><?php echo e($assetdata->date_dev); ?></td>
                            <td><?php echo e($assetdata->price_val); ?></td>
                            <td><?php echo e($assetdata->payment_term); ?></td>
                            <td><?php echo e($assetdata->unit); ?></td>
                            <td><?php echo e($assetdata->quantity); ?></td>
                            <td><?php echo e($assetdata->unit_cost); ?></td>
                            <td><?php echo e($assetdata->quantity * $assetdata->unit_cost); ?></td>
                        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/assets/purchase_order.blade.php ENDPATH**/ ?>