...
<html lang="en">
    ...
    <body>
        ...
        <div>
            <h4>
                <a href="<?php echo e(url('/addsupplier')); ?>" class="btn btn-primary"><strong>ADD SUPPLIER</strong></a>
            </h4>
        <div>
        <div class="profile">
            ...
            <div class="table-container">
                <table class="table table-bordered">
                    <thead>
                        ...
                        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplierdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($supplierdata->name); ?></td>
                            <td><?php echo e($supplierdata->address); ?></td>
                            <td><?php echo e($supplierdata->contact_number); ?></td>
                            <td>
                                <a href="<?php echo e(url('/deletesupplier/'.$supplierdata->id)); ?>" class="btn btn-delete">Delete</a>
                            </td>
                        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/assets/suppliers.blade.php ENDPATH**/ ?>