...
<html lang="en">
    ...
    <body>
        <h1 class="label"><strong>Assets :Issuance</strong></h1>
        ...
        <div class="side-bar" style="padding: 10px;">
            ...
            <div class="items">
                ...
                <a class="issuance" href="/issuance-view" style="color: #4F74BB; background-color: transparent; display: block; text-align: right; padding-right: 10px; font-family: Arial">Issuance</a>
            ...
            <div class="table-container">
                <table class="table table-bordered">
                    <thead>
                        ...
                        <tr>
                            <td><?php echo e($assetdata->par_no); ?></td>
                            <td><?php echo e($assetdata->description); ?></td>
                            <td><?php echo e($assetdata->date_acquired); ?></td>
                            <td><?php echo e($assetdata->property_no); ?></td>
                            <td><?php echo e($assetdata->unit); ?></td>
                            <td><?php echo e($assetdata->issue_qty); ?></td>
                            <td><?php echo e($assetdata->unit_cost); ?></td>
                            <td><?php echo e($assetdata->issue_qty * $assetdata->unit_cost); ?></td>
                            <td>
                                <a href="<?php echo e(url('/editissuance/'.$assetdata->item_no)); ?>" class="btn btn-edit">Edit</a>
                            </td>
                        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/assets/displayissuance.blade.php ENDPATH**/ ?>