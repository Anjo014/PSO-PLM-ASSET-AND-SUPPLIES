...
<html lang="en">
    ...
    <body>
        ...
        <div>
            <h4>
                <a href="<?php echo e(url('/addsupplies')); ?>" class="btn btn-primary"><strong>ADD SUPPLIES</strong></a>
            </h4>
        <div>
        <div class="profile">
        ...
        <div class="notifdropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="notificationButton">
                <?php $__currentLoopData = $notifications->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="dropdown-item">
                        <p>Timestamp: <?php echo e($notification->created_at); ?></p>
                        <p>Action: <?php echo e($notification->type); ?></p>
                        <p>Stock No.: <?php echo e($notification->details); ?></p>
                        <p>Item: <?php echo e($notification->item); ?></p>
                    </div>
        ...
        <div class="container">
            <div class="table-container">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $supplies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suppliesdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e(isset($suppliesdata->balance_after) ? $suppliesdata->status : 'No value yet'); ?></td>
                            <td><?php echo e($suppliesdata->updated_at); ?></td>
                            <td>
                                <a href="<?php echo e(url('deletesupply/'.$suppliesdata->stock_no)); ?>" class="btn-delete" style="text-decoration: none;" onclick="return confirm('Are you sure you want to delete this data with Stock No. <?php echo e($suppliesdata->stock_no); ?> in the supplies?')">Delete</a>
                                <a href="<?php echo e(url('editsupplies/'.$suppliesdata->pr_no)); ?>" class="btn-edit" style="text-decoration: none;">Edit</a>
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/supplies/displaysupplies.blade.php ENDPATH**/ ?>