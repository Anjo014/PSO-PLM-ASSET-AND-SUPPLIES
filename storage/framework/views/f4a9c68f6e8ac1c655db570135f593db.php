        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h1><bold>Edit Supply Main</bold></h1>
                            <form action="<?php echo e(url('/supplies/'.$supply->stock_no)); ?>" class="form-body" method="POST" autocomplete="off">
                                <?php echo csrf_field(); ?> 
                                <?php echo method_field('PUT'); ?> 
                                <div class="input-group">
                                    <label for="stock_no"><strong>Stock No:</strong></label>
                                    <input type="text" name="stock_no" value="<?php echo e(old('stock_no', $supply->stock_no)); ?>" readonly style="width: 1100px; height: 32px; background-color: rgba(209,223,255,255); border: 0.5px solid #000; border-radius: 2px; padding-left: 12px; color: rgba(86,93,103,255)">
                                </div>
                                <div class="input-group">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="balance_before" value="<?php echo e($supply->balance_before); ?>" class="form-control <?php $__errorArgs = ['balance_before'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="delivered" value="<?php echo e($supply->delivered); ?>" class="form-control <?php $__errorArgs = ['delivered'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="issued" value="<?php echo e($supply->issued); ?>" class="form-control <?php $__errorArgs = ['issued'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="balance_after" value="<?php echo e($supply->balance_after); ?>" class="form-control <?php $__errorArgs = ['balance_after'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/supplies/edit.blade.php ENDPATH**/ ?>