...
<html lang="en">
    ...
    <body>
        <h1 class="label"><strong>Assets :Main</strong></h1>
        ...
        <div>
            <h4>
                <a href="<?php echo e(url('/addasset')); ?>" class="btn btn-primary"><strong>ADD ASSET</strong></a>
            </h4>
        <div>
        <div class="profile">
                ...
                <table class="table table-bordered">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($assetdata->class_id); ?></td>
                            <td><?php echo e($assetdata->category); ?></td>
                            <td><?php echo e($assetdata->description); ?></td>
                            <td><?php echo e($assetdata->details); ?></td> 
                            <td>
                                <a href="<?php echo e(url('/editasset/'.$assetdata->pr_no)); ?>" class="btn btn-edit">Edit</a>
                                <a href="<?php echo e(url('/deleteasset/'.$assetdata->pr_no)); ?>" class="btn btn-delete">Delete</a>
                            </td>
                        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/assets/displayassets.blade.php ENDPATH**/ ?>