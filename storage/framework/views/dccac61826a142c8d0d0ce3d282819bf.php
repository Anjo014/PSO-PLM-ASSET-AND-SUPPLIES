...
<body >
    ...
    <div>
    <pre style="font-family: Arial; font-size: 15px;">   Division: <?php echo e(session('form_data.division')); ?>              Responsibility Center: <?php echo e(session('form_data.center')); ?>            RIS No: <?php echo e(session('form_data.ris')); ?>

   Office: <?php echo e(session('form_data.office')); ?>                 Code: <?php echo e(session('form_data.code')); ?>                                       SAI No: <?php echo e(session('form_data.sai')); ?>                              Date: <?php echo e(date('Y-m-d')); ?>
    ...
    <table style="border: 1px solid black; text-align: center;">
        ...
        <?php if(is_array(session('form_data.stock_no'))): ?>
                <?php $__currentLoopData = session('form_data.stock_no'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stock_no): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($stock_no); ?></td>
                        <td><?php echo e(session('form_data.unit')[$index]); ?></td>
                        <td colspan="5"><?php echo e(session('form_data.description')[$index]); ?></td>
                        <td><?php echo e(session('form_data.rqty')[$index]); ?></td>
                        <td><?php echo e(session('form_data.iqty')[$index]); ?></td>
                        <td><?php echo e(session('form_data.remarks')[$index]); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php else: ?>
                <tr>
                    <td><?php echo e(session('form_data.stock_no')); ?></td>
                    <td><?php echo e(session('form_data.unit')); ?></td>
                    <td colspan="5"><?php echo e(session('form_data.description')); ?></td>
                    <td><?php echo e(session('form_data.rqty')); ?></td>
                    <td><?php echo e(session('form_data.iqty')); ?></td>
                    <td><?php echo e(session('form_data.remarks')); ?></td>
                </tr>
            <?php endif; ?>
    
            <tr>
            <td colspan="10" style="text-align: left;">Purposes: <?php echo e(session('form_data.purpose')); ?></td>
            </tr>
            <tr>
            ...
            <td colspan="2" style="text-align: left;">Issued by: <?php echo e(session('form_data.issued')); ?></td>
            <td colspan="2" style="text-align: left;">Accepted by: <?php echo e(session('form_data.accepted')); ?></td>
            </tr>
            <tr>
            ...
            <td colspan="8" style="text-align: left;"> <?php echo e(session('form_data.printedname')); ?></td>
            </tr>
            <tr>
            <td colspan="2" style="text-align: left;">Designation:</td>
            <td colspan="8" style="text-align: left;"> <?php echo e(session('form_data.designation')); ?></td>
            </tr>
    </table>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo e(route('generatePDF1')); ?>">
                            <?php echo csrf_field(); ?>
                        ...
                        <td>
                            <select class="form-control stock-input" name="stock_no[]">
                                ...
                                <?php $__currentLoopData = $supplies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!is_null($supply->stock_no)): ?>
                                        <option value="<?php echo e($supply->stock_no); ?>"><?php echo e($supply->stock_no); ?></option>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </td>
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/supplies/risform.blade.php ENDPATH**/ ?>