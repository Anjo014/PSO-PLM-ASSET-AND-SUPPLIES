        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h1><strong>Edit Purchase Order</strong></h1>
                            <form action="<?php echo e(url('/updatepurchaseorder/'.$asset->item_no)); ?>" class="form-body" method="POST" autocomplete="off">
                                ...
                                <div class="input-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="item_no" value="<?php echo e(old('item_no', $asset->item_no)); ?>" readonly style="width: 275px; height: 32px; background-color: rgba(209,223,255,255); border: 0.5px solid #000; border-radius: 2px; padding-left: 12px; color: rgba(86,93,103,255)">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="po_no" value="<?php echo e($asset->po_no); ?>" class="form-control <?php $__errorArgs = ['po_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="supplier" value="<?php echo e($asset->supplier); ?>" class="form-control <?php $__errorArgs = ['supplier'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="address" value="<?php echo e($asset->address); ?>" class="form-control <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        <label for="tel_no"><strong>Tel No.:</strong></label>
                                        <input type="text" name="tel_no" value="<?php echo e($asset->tel_no); ?>" class="form-control <?php $__errorArgs = ['tel_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="input-group1">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="tin_no" value="<?php echo e($asset->tin_no); ?>" class="form-control <?php $__errorArgs = ['tin_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="date" value="<?php echo e($asset->date); ?>" class="form-control <?php $__errorArgs = ['date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="mode_of_proc" value="<?php echo e($asset->mode_of_proc); ?>" class="form-control <?php $__errorArgs = ['mode_of_proc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="pr_no" value="<?php echo e($asset->pr_no); ?>" class="form-control <?php $__errorArgs = ['pr_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="place_dev" value="<?php echo e($asset->place_dev); ?>" class="form-control <?php $__errorArgs = ['place_dev'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="date_dev" value="<?php echo e($asset->date_dev); ?>" class="form-control <?php $__errorArgs = ['date_dev'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="input-group2">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="price_val" value="<?php echo e($asset->price_val); ?>" class="form-control <?php $__errorArgs = ['price_val'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="payment_term" value="<?php echo e($asset->payment_term); ?>" class="form-control <?php $__errorArgs = ['payment_term'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="quantity" value="<?php echo e($asset->quantity); ?>" class="form-control <?php $__errorArgs = ['quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="unit" value="<?php echo e($asset->unit); ?>" class="form-control <?php $__errorArgs = ['unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="unit_cost" value="<?php echo e($asset->unit_cost); ?>" class="form-control <?php $__errorArgs = ['unit_cost'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/assets/edit_purchase_order.blade.php ENDPATH**/ ?>