        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h1><bold>Edit Issued Supply</bold></h1>
                            <form action="<?php echo e(url('/supplies-issued/'.$supply->report_no)); ?>" class="form-body" method="POST" autocomplete="off">
                                <?php echo csrf_field(); ?> 
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="date_issuance" value="<?php echo e($supply->date_issuance ?? ''); ?>" class="form-control <?php $__errorArgs = ['date_issuance'];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        <label for="requesting_office"><strong>Actual Delivery Date:</strong></label>
                                        <input type="text" name="requesting_office" value="<?php echo e($supply->requesting_office ?? ''); ?>" class="form-control <?php $__errorArgs = ['requesting_office'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="report_no" value="<?php echo e($supply->report_no ?? ''); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/supplies/iedit.blade.php ENDPATH**/ ?>