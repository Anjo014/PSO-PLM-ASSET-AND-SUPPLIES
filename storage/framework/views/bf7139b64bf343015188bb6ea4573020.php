    ...
    <div class=" row"></div>
        <div class="col-lg-3">
            <div class="card-body">
                ...
                <form action="<?php echo e(route('login', 'asset')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/assetindex.blade.php ENDPATH**/ ?>