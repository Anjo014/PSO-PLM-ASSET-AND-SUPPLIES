...
<html lang="en">
    ...
    <body>
        ...
        <h1>Archived Supplies</h1>
        <a href="<?php echo e(url('/supplies-view')); ?>" class="btn btn-primary"><strong>Back to Main</strong></a>
        <div class="profile">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $supplies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('pages.supplies.recover', ['stock_no' => $supply->stock_no])); ?>" class="btn-recover">Recover</a>
                                    <form method="POST" action="<?php echo e(route('pages.supplies.forceDelete', ['stock_no' => $supply->stock_no])); ?>">
                                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\softeng\laravel\plm_inventory\resources\views/pages/supplies/archive.blade.php ENDPATH**/ ?>